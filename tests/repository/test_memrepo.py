...
from ddd_attempt1.shared.domain_model import DomainModel

from ddd_attempt1.repository import memrepo
...
def test_repository_with_filters_unknown_operator(storageroom_dicts):
    repo = memrepo.MemRepo(storageroom_dicts)
